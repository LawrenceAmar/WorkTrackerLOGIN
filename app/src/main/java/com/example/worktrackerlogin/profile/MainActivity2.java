...
import com.example.worktrackerlogin.databinding.ActivityMain2Binding;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_productList, R.id.nav_cropList, R.id.nav_datageneratedpage)
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            else if (id == R.id.nav_datageneratedpage) {
                Bundle bundle = new Bundle();
                bundle.putString("username", usernameUser);
                navController.navigate(R.id.nav_datageneratedpage, bundle);
            }
